...
SineWaveGenerator.prototype._resizeWidth = function() {
  ...
  this.width = this.el.width = this.el.parentElement.offsetWidth * this.dpr;
  this.height = '100'; // this.el.height = this.el.parentElement.offsetHeight * this.dpr;
  this.el.style.width = this.el.parentElement.offsetWidth + 'px';  // '98vw';
  this.el.style.height = '100px'; // this.el.parentElement.offsetHeight + 'px';  // '375px';
